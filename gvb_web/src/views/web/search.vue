      ...
      <div class="gvb_inner_container">
        ...
        <div class="gvb_search_action">
          ...
          <div class="gvb_search_tags">
            ...
            <span :class="{ active: data.query.tag === item.tag }" @click="checkTag(item.tag)"
              v-for="(item, index) in data.tag_list" :key="index">{{ item.tag }}</span>
          </div>
        </div>
        <div class="gvb_search_result">
          <div class="gvb_search_result_item" v-for="(item, index) in data.article_list" :key="index">
            ...
            <div class="info">
              ...
              <div class="icon">
                <span v-if="data.query.sort === 'digg_count desc'"><i class="fa fa-thumbs-up"></i>{{ item.digg_count
                  }}</span>
                <span v-else-if="data.query.sort === 'comment_count desc'"><i class="fa fa-comments"></i>{{
                  item.comment_count }}</span>
                <span v-else-if="data.query.sort === 'collects_count desc'"><i class="fa fa-star-o"></i>{{
        ...
        <div class="gvb_search_page">
          <a-pagination class="article_list_page" v-model:current="data.query.page" hideOnSinglePage :total="data.total"
            @change="pageChange" :show-total="total => `共 ${total} 篇`" />
        </div>
      </div>
    </div>
    <GVBFooter></GVBFooter>
