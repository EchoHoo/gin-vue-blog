...
type ArticleModel struct {
	...
	CreateAt string `json:"created_at" structs:"created_at"` //创建时间
	Update   string `json:"updated_at" structs:"updated_at"` //更新时间

	Title   string `json:"title" structs:"title"`                //文章标题
	Keyword string `json:"keyword,omit(list)" structs:"keyword"` //文章关键词
	Abstact string `json:"abstract" structs:"abstract"`          //文章简介
